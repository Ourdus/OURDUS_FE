...
//   }, [])
  return (
    ...
    <Link to={"/main/class/classcategory/Classbeauty"} className="notextdecoration">
    <PickedLocaldetailedDiv>천연화장품&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <Classproductlist>클래스 ▶ 뷰티</Classproductlist>
    </Allclasspage>
  );
}

export default Classbeauty;
